...
"""
dosyada okuma islemi yapiyoruz ilk for dongusunu maskeli ve maskesiz adli dosyalarimiza ulasmak icin kullaniyoruz 
2.for u ise o dosyalarin icindeki veriye ulasmak icin kullaniyoruz.. 
"""
...
#%% Veri Ayirma
x_train, x_test, y_train, y_test = train_test_split(images,classno, test_size = 0.27,stratify=classno, random_state = 21)
...
open("modelveri3.json","w").write(model.to_json())
model.save_weights("weight_veri3.h5")
